...
def main():
    ...
    texture = meshdd.get_texture_from_image(imageio.imread(options.texture[0]))
    print("Done.")
    ...
    displaced_vertices = meshdd.displace_vertices(vertices, normals, -options.depth, displace_mask)
    print("Done.")
    ...
    mesh_interface.write(filename_prefix + "_displaced" + filename_extension, displaced_vertices, faces)
    print("Done.")
